            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex gap-2 w-full">
                  ...
                  <Link
                    href={`/candidato/${c.id}`}
                    className="flex-1 flex items-center justify-center gap-1 text-xs font-semibold py-2.5 rounded-lg border-2 transition-all duration-200 hover:shadow-md"
                    style={{
                      color: c.cor,
                  ...
                  {c.pdfUrl && (
                    <a
                      ...
                      className="flex-1 flex items-center justify-center gap-1 text-xs font-semibold py-2.5 rounded-lg border-2 transition-all duration-200 hover:shadow-md text-slate-600 border-slate-200 bg-slate-50 dark:text-slate-300 dark:border-slate-700 dark:bg-slate-800"
                    >
                      📄 PDF
                    </a>
                  )}
